...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Happening.town'
        db.alter_column('agenda_happening', 'town_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['agenda.Town'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Happening.town'
        raise RuntimeError("Cannot reverse this migration. 'Happening.town' and its values cannot be restored.")
