...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlipMedia.title'
        db.add_column('multimedia_blipmedia', 'title', self.gf('django.db.models.fields.CharField')(default=' ', max_length=300), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BlipMedia.title'
        db.delete_column('multimedia_blipmedia', 'title')
