...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'BlipAccount', fields ['user']
        db.create_unique('multimedia_blipaccount', ['user'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BlipAccount', fields ['user']
        db.delete_unique('multimedia_blipaccount', ['user'])
